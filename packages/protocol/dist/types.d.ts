 ...
 */
export declare const BLOCKS_SCHEMA: "blocksmith.blocks.v1";
export declare const LOCK_SCHEMA: "blocksmith.lock.v1";
export declare const REGISTRY_SCHEMA: "blocksmith.registry.v1";
export declare const COMPILE_TARGETS_SCHEMA: "blocksmith.compile-targets.v1";
export type BlockStatus = "draft" | "finalized" | "stale" | "conflict";
export type BlockType = "component" | "token" | "guideline" | "agent-rule" | "page";
export type IngestSource = "scan" | "markdown" | "governance" | "figma" | "paste" | "storybook" | "agent-template";
