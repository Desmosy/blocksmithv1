...
Spin-off layout library for BlockSmith — uses [Cheng Lou's Pretext](https://github.com/chenglou/pretext) for canvas-accurate text measurement inside design-system component frames.
